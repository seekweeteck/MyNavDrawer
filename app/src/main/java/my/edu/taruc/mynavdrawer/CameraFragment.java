package my.edu.taruc.mynavdrawer;
...
public class CameraFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonClickMe = (Button)rootView.findViewById(R.id.buttonClickMe);

        buttonClickMe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                editTextName.setText("Clicked");
            }
        });
    ...
    public void onPause() {
        ...
        editor.putString(getString(R.string.name), editTextName.getText().toString());
        editor.commit();
    }
}
